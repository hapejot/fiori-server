...
pub fn meta_package_apps() -> Vec<App> {
    vec![
        App::new(
            "MetaConfigApp".into(),
            "EntityConfigs".into(),
            "Metadata Configuration".into(),
            Some("Configure the metadata that drives the app generator.".into()),
            Some("sap-icon://settings".into()),
            Package::new(PKG),
        ),
        App::new(
            "FieldValueListsApp".into(),
            "FieldValueLists".into(),
            "Field Value Lists".into(),
            Some("Manage reusable value lists for fields.".into()),
            Some("sap-icon://value-help".into()),
            Package::new(PKG),
        ),
    ]
}
...
pub fn entity_fields() -> EntitySpec {
    EntitySpec {
        ...
        fields: vec![
            ...
            FieldSpec::string("ReferencesEntity", "References Entity", 40).form_group("FieldProps"),
            ...
            FieldSpec::string("LineItemImportance", "Line Item Importance", 10)
                .form_group("LineItemProps"),
            FieldSpec::string("LineItemLabel", "Line Item Label", 80).form_group("LineItemProps"),
...
pub fn entity_facets() -> EntitySpec {
    EntitySpec {
        ...
        fields: vec![
            ...
            FieldSpec::string("FieldGroupLabel", "Field Group Label", 80).form_group("FacetInfo"),
...
pub fn entity_table_facets() -> EntitySpec {
    EntitySpec {
        ...
        fields: vec![
            ...
            FieldSpec::string("NavigationProperty", "Navigation Property", 40).form_group("TFInfo"),
    ...
    EntitySpec {
        ...
        fields: vec![
            ...
            FieldSpec::string("OneEntity", "One-Side Entity", 40)
                ...
                .show_in_list()
                .with_value_list(
                    AtomValueList::entity_ref("EntityConfigs", "SetName", None).dialog(),
                ),
            FieldSpec::string("OneNavName", "One-Side Nav Name", 40).form_group("OneSide"),
            ...
            FieldSpec::string("ManyNavName", "Many-Side Nav Name", 40).form_group("ManySide"),
            FieldSpec::bool_field("IsComposition", "Composition")
                .form_group("Basic")
                .show_in_list(),
            FieldSpec::string("FkField", "FK Field", 40).form_group("ManySide"),
            FieldSpec::string("FkLabel", "FK Label", 80).form_group("ManySide"),
            FieldSpec::string("FkFormGroup", "FK Form Group", 40).form_group("ManySide"),
            FieldSpec::string("ConditionType", "Condition Type", 20).form_group("Condition"),
...
mod tests {
    ...
    fn test_meta_package_resolves() {
        ...
        let fields = resolved
            .iter()
            .find(|e| e.set_name == "EntityFields")
            .unwrap();
        ...
        let lists = resolved
            .iter()
            .find(|e| e.set_name == "FieldValueLists")
            .unwrap();
        ...
        let items = resolved
            .iter()
            .find(|e| e.set_name == "FieldValueListItems")
            .unwrap();
