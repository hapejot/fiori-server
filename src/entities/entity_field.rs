...
impl ODataEntityImp for EntityFieldEntity {
    ...
    fn fields_def(&self) -> Option<&'static [FieldDef]> {
        static FIELDS: LazyLock<Vec<FieldDef>> = LazyLock::new(|| {
            // value_source stores the UUID of the FieldValueList, not the name
            ...
            vec![
                ...
                FieldDef {
                    ...
                    computed: false,
                    references_entity: None,
                    value_source: Some(edm_types_id),
                    prefer_dialog: false,
                    text_path: None,
                    searchable: false,
                    show_in_list: true,
                ...
                FieldDef {
                    ...
                    value_source: None,
                    prefer_dialog: false,
                    text_path: Some("_ValueList/ListName"),
                    searchable: false,
                    show_in_list: false,
                    list_sort_order: None,
                    list_importance: None,
                ...
                FieldDef {
                    ...
                    searchable: false,
                    show_in_list: true,
                    list_sort_order: Some(8),
                    list_importance: Some("Low"),
                    list_criticality_path: None,
                    form_group: Some("FieldProps"),
                },
                FieldDef {
                ...
                FieldDef {
                    ...
                    list_importance: Some("High"),
                    list_criticality_path: None,
                    form_group: Some("LineItemProps"),
                },
                FieldDef {
                    name: "LineItemImportance",
                    label: "Wichtigkeit",
                    edm_type: "Edm.String",
                    max_length: Some(10),
                    precision: None,
                ...
                FieldDef {
                    name: "LineItemCriticalityPath",
                    label: "Kritikalitaets-Pfad",
                    edm_type: "Edm.String",
                    max_length: Some(40),
                    precision: None,
                    scale: None,
                ...
                FieldDef {
                    name: "LineItemSemanticObject",
                    label: "Listen-Sem.Object",
                    edm_type: "Edm.String",
                    max_length: Some(40),
                    precision: None,
                    scale: None,
    ...
    fn navigation_properties(&self) -> &'static [NavigationPropertyDef] {
        static NAV: &[NavigationPropertyDef] = &[
            ...
            NavigationPropertyDef {
                name: "_ValueList",
                target_type: "FieldValueList",
                is_collection: false,
                foreign_key: Some("ValueSource"),
            },
        ];
        NAV
    }
    ...
    fn annotations_def(&self) -> Option<&'static AnnotationsDef> {
        static DEF: AnnotationsDef = AnnotationsDef {
            ...
            facet_sections: &[
                FacetSectionDef {
                    label: "Feldeigenschaften",
                    id: "FieldProps",
                    field_group_qualifier: "FieldProps",
                    field_group_label: "Eigenschaften",
                },
                FacetSectionDef {
                    label: "Listen-Konfiguration",
                    id: "LineItemProps",
                    field_group_qualifier: "LineItemProps",
                    field_group_label: "LineItem",
                },
            ],
            table_facets: &[],
        };
