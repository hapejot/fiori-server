...
impl ODataEntity for EntityFacetEntity {
    ...
    fn fields_def(&self) -> Option<&'static [FieldDef]> {
        static FIELDS: &[FieldDef] = &[
            FieldDef { name: "FacetID",              label: "Facet-ID",            edm_type: "Edm.String", max_length: Some(80),  precision: None, scale: None, immutable: true,  semantic_object: None },
            ...
            FieldDef { name: "SectionLabel",         label: "Abschnitt-Label",      edm_type: "Edm.String", max_length: Some(80),  precision: None, scale: None, immutable: false, semantic_object: None },
            FieldDef { name: "SectionId",            label: "Abschnitt-ID",         edm_type: "Edm.String", max_length: Some(40),  precision: None, scale: None, immutable: false, semantic_object: None },
            FieldDef { name: "FieldGroupQualifier",  label: "FieldGroup-Qualifier", edm_type: "Edm.String", max_length: Some(40),  precision: None, scale: None, immutable: false, semantic_object: None },
            FieldDef { name: "FieldGroupLabel",      label: "FieldGroup-Label",     edm_type: "Edm.String", max_length: Some(80),  precision: None, scale: None, immutable: false, semantic_object: None },
            FieldDef { name: "FieldGroupFields",     label: "Felder (kommasep.)",   edm_type: "Edm.String", max_length: Some(500), precision: None, scale: None, immutable: false, semantic_object: None },
