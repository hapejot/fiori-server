...
impl ODataEntity for EntityTableFacetEntity {
    ...
    fn fields_def(&self) -> Option<&'static [FieldDef]> {
        static FIELDS: &[FieldDef] = &[
            FieldDef { name: "TableFacetID",       label: "TableFacet-ID",      edm_type: "Edm.String", max_length: Some(80),  precision: None, scale: None, immutable: true,  semantic_object: None, value_source: None , value_list: None, text_path: None},
            ...
            FieldDef { name: "FacetLabel",         label: "Label",              edm_type: "Edm.String", max_length: Some(80),  precision: None, scale: None, immutable: false, semantic_object: None, value_source: None , value_list: None, text_path: None},
            FieldDef { name: "FacetId",            label: "Facet-ID",           edm_type: "Edm.String", max_length: Some(40),  precision: None, scale: None, immutable: false, semantic_object: None, value_source: None , value_list: None, text_path: None},
            FieldDef { name: "NavigationProperty", label: "Navigation Property", edm_type: "Edm.String", max_length: Some(40),  precision: None, scale: None, immutable: false, semantic_object: None, value_source: None , value_list: None, text_path: None},
